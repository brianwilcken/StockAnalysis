...
//		try {
//			List<IndexedStock> indexedStocks = solrClient.CollectIndexedEventsFromAnalyzedEvents(analyzedEvents);
//			categorizer.detectEventDataCategories(indexedStocks);
//			solrClient.indexDocuments(indexedStocks);
...
//	}
//
//	public List<IndexedStock> detectEventDataCategories(List<IndexedStock> events, int... numTries) throws IOException {
//		try {
...
//						solrClient::formatForEventCategorization, new SolrClient.StockNewsCategorizationThrottle(SolrConstants.Events.CATEGORY_IRRELEVANT, THROTTLE_FOR_IRRELEVANT_EVENTS));
//
